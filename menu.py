...
class Menus:
    def main_menu(self, screen, screen_width, screen_height):
        ...
        while True:
            ...
            sprint_button = Button(image=None, pos=(screen_width * 0.5, screen_height * 0.8), text_input="SPRINT", font = pygame.font.Font(FONT_PATH, 50), base_color="black", hovering_color="red")
